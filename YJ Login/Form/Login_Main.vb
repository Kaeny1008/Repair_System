Public Class Login_Main
    ...
    Private Sub OK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK.Click
        ...
        If cb_RunProgram.Text = "Repair System" Then
            ...
            run_file += "\Repair_System.exe"
        ElseIf cb_RunProgram.Text = "오삽방지 시스템" Then
            '마지막 Login된 ID를 기록
            registryEdit.WriteRegKey("Software\Yujin\MMS_MMPS\Login", "User ID", USER_ID.Text)
            registryEdit.WriteRegKey("Software\Yujin\MMS_MMPS\Login", "Site", cb_RunProgram.Text)

            If CB_PASS_SAVE.Checked Then
                registryEdit.WriteRegKey("Software\Yujin\MMS_MMPS\Login", "Pass Save", "Yes")
                registryEdit.WriteRegKey("Software\Yujin\MMS_MMPS\Login", "Pass", USER_PASS.Text)
            Else
                registryEdit.WriteRegKey("Software\Yujin\MMS_MMPS\Login", "Pass Save", "No")
                registryEdit.WriteRegKey("Software\Yujin\MMS_MMPS\Login", "Pass", String.Empty)
            End If
    ...
    Private Sub MMSLogin_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If cb_RunProgram.Text = "Repair System" Then
            ...
            End If
        ElseIf cb_RunProgram.Text = "오삽방지 시스템" Then
            USER_ID.Text = registryEdit.ReadRegKey("Software\Yujin\MMS_MMPS\Login", "User ID", "ADMIN")

            If Not USER_ID.Text = "" Then USER_PASS.Focus()

            If registryEdit.ReadRegKey("Software\Yujin\MMS_MMPS\Login", "Pass Save", "No") = "Yes" Then
                CB_PASS_SAVE.Checked = True
                USER_PASS.Text = registryEdit.ReadRegKey("Software\Yujin\MMS_MMPS\Login", "Pass", String.Empty)
            End If
        End If
